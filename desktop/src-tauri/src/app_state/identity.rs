...
pub(super) const IDENTITY_KEY_NAME: &str = "identity";
...
pub(super) const MIGRATION_MARKER_NAME: &str = "identity.migrated";
...
pub(super) trait IdentityKeyStore {
...
pub(super) fn resolve_identity_with_store(
...
pub(super) fn recover_from_keyring(
    store: &impl IdentityKeyStore,
    legacy_path: &std::path::Path,
    data_dir: &std::path::Path,
    error: &str,
...
pub(super) fn load_file_or_generate(
    legacy_path: &std::path::Path,
    data_dir: &std::path::Path,
) -> Result<Keys, String> {
    if legacy_path.exists() {
...
pub(super) fn migrate_identity_file(
    store: &impl IdentityKeyStore,
    legacy_path: &std::path::Path,
    data_dir: &std::path::Path,
...
/// deleting the file.
pub(super) fn persist_identity_to_keyring(
    store: &impl IdentityKeyStore,
    keys: &Keys,
    legacy_path: &std::path::Path,
    data_dir: &std::path::Path,
...
pub(super) fn persist_imported_identity_impl(
    store: &impl IdentityKeyStore,
    keys: &Keys,
    legacy_path: &std::path::Path,
    data_dir: &std::path::Path,
