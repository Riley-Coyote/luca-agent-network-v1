...
pub fn run() {
    ...
    let app = builder
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            luca::activity_trace::luca_list_activity_traces,
            ...
            resolve_capability_skill_activation,
            get_resident_session_capabilities,
            pick_runtime_task_folder,
            resolve_runtime_task_project_folder,
            start_runtime_task,
            cancel_runtime_task,
            retry_runtime_task,
            list_runtime_tasks,
            get_runtime_task_result,
            list_runtime_task_proposals,
            respond_runtime_task_proposal,
            luca::repository_connection_proposals::list_repository_connection_proposals,
            luca::repository_connection_proposals::authorize_repository_connection_proposal,
            ...
            list_resident_documents,
            read_resident_document,
            write_resident_document,
            get_resident_place,
            update_resident_place,
            set_resident_place_editing,
            list_resident_place_work,
            ...
            list_luca_mcp_registry,
            save_luca_mcp_connection,
            ...
            pick_conversation_context_folder,
            promote_conversation_context_to_project,
            remove_conversation_context_override,
            ...
            luca::native_provisioning::reconcile_native_agent_provisioning,
