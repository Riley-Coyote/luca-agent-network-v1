      ...
      <Popover modal={false} onOpenChange={handleOpenChange} open={open}>
        ...
        >
          <div className="group/search flex cursor-text items-center gap-2 border-b border-border/50 px-3 py-2">
            <Search className="h-3.5 w-3.5 shrink-0 text-ink-faint transition-colors duration-150 ease-out group-focus-within/search:text-foreground" />
            <input
              aria-label="Search models"
              autoCapitalize="none"
              autoComplete="off"
              autoCorrect="off"
              className="block min-w-0 flex-1 border-0 bg-transparent p-0 text-sm leading-5 text-ink-faint shadow-none outline-none placeholder:text-ink-faint focus:text-foreground focus:placeholder:text-muted-foreground"
