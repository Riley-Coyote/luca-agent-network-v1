...
export function TranscriptTimestamp({
  ...
  if (href) {
    return (
      <a
        className={cn(
          "shrink-0 rounded-sm text-xs text-ink-faint transition-colors hover:text-ink-faint focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring",
          className,
        )}
  ...
  return (
    <span
      className={cn(
        "shrink-0 cursor-default text-xs text-ink-faint",
        className,
      )}
      title={fullDateTime}
    >
