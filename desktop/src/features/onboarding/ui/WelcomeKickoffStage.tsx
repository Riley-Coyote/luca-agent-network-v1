  ...
  return (
    ...
    >
      {STAGE_CHARACTERS.map((character, index) => (
        <span
          className="motion-kickoff-character-enter flex h-8 items-center rounded-md border border-border/70 bg-background/95 px-3 font-mono text-2xs uppercase tracking-caps-wide text-muted-foreground shadow-sm"
