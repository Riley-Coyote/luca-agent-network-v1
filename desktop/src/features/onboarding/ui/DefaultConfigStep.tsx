...
function formatHarnessLabel(runtime: AcpRuntimeCatalogEntry | undefined) {
  ...
  return runtime.id === "buzz-agent" ? "Local runtime" : runtime.label;
}
      ...
      {configSurfaceLoading ? (
        ...
        <div className="space-y-7">
          <div className="space-y-4">
            ...
            <AgentDropdownSelect
              className="h-12 rounded-2xl border border-foreground/15 bg-foreground/[0.06] px-4 py-2 text-sm shadow-none hover:bg-foreground/10"
