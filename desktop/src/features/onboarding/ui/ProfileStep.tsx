    ...
    >
      <div className="w-full max-w-2xl">
        ...
        <p className="mt-5 text-sm leading-6 text-muted-foreground">
          Pick the name your residents will use. You can change it anytime.
        </p>
      </div>
      ...
      >
        ...
        <div className="relative h-20 w-full max-w-[576px]">
          {!hasDisplayNameDraft ? (
            ...
            >
              <span className="relative inline-flex select-none items-center gap-0 text-4xl font-semibold text-ink-faint sm:text-5xl">
                <span
                  aria-hidden="true"
