...
test("visible onboarding runtimes use the product order", () => {
  const runtimes = [
    ...
    runtime("grok", "available", "logged_in"),
    runtime("kimi", "available", "logged_in"),
  ];
