      ...
      <Dialog onOpenChange={onOpenChange} open={open}>
        ...
        >
          <DialogHeader className="space-y-0 pb-5">
            ...
            >
              <UserRoundPlus className="h-4 w-4 shrink-0 text-ink-faint transition-colors duration-150 ease-out group-hover/search:text-muted-foreground group-focus-within/search:text-foreground" />
              <input
                autoCapitalize="none"
                autoCorrect="off"
...
function SearchResultSectionTitle({
  ...
  return (
    <div className="sticky top-0 z-10 mr-3 flex min-h-9 items-center gap-2 bg-background/95 px-4 pb-1.5 pt-3 text-xs font-medium text-ink-faint backdrop-blur supports-[backdrop-filter]:bg-background/80">
      <span>{children}</span>
