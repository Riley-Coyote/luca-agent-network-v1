  ...
  const editor = useEditor(
    {
      ...
      editorProps: {
        attributes: {
          autocapitalize: "none",
          autocorrect: "off",
          class: `${MESSAGE_MARKDOWN_CLASS} min-h-0 resize-none overflow-y-hidden border-0 bg-transparent px-0 py-0 text-base leading-[1.68] text-foreground shadow-none focus-visible:ring-0 caret-foreground outline-hidden max-w-none`,
