        ...
        return (
          ...
          >
            ...
            {Object.keys(step.output).length > 0 ? (
              <div className="mt-3">
                <p className="mb-1 text-2xs font-medium uppercase tracking-caps-wide text-muted-foreground">
                  Output
                </p>
            ...
            {step.error ? (
              <div className="mt-3">
                <p className="mb-1 text-2xs font-medium uppercase tracking-caps-wide text-red-400">
                  Error
                </p>
            ...
            {pendingApproval ? (
              <div className="mt-3">
                <p className="mb-2 text-2xs font-medium uppercase tracking-caps-wide text-amber-600">
                  Pending approval
                </p>
