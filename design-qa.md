...
- Fonts and typography: Instrument Sans is used for navigation and conversation; Fragment Mono is restricted to receipts, timestamps, shortcuts, and provenance; Doto is restricted to the active display. Product text is no longer rendered as ornamental microtype.
