...
- [x] **DefaultConfigStep white inputs** (`bg-white` selects) → dark input surface
      (`bg-foreground/[0.06]` + hairline). Code + gates done; **visual confirm pending**
      (mock gates the config step behind a ready runtime — confirm on the real app).
