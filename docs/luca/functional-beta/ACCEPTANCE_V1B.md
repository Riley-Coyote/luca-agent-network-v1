...
| A103 | Real profile memory, workspace, and permission-gated tool checks pass or report honest unsupported states. | PASS | `NATIVE_PARITY_CONTRACT.md`, `receipts/N02.md`, `receipts/R01.md`, historical G1 native evidence |
| A104 | Hermes/OpenClaw DMs, restart, and mixed-room attribution remain correct. | PASS | `receipts/R01.md`, historical G1 native evidence |
...
| A208 | Fresh Hermes/OpenClaw sessions use the latest effective handoff without native-resume claims. | PASS | `receipts/R01.md` |
...
| A401 | Installed app passes real native capability and fresh-session continuity demo. | PASS | `receipts/R01.md` |
| A402 | Installed failure drills preserve messaging and exactly-once publication. | PASS | `receipts/R01.md`, `receipts/R02.md`, historical G1 failure evidence |
| A403 | Artifact, database, WAL/SHM, log, relay, and child-environment scans contain no handoff plaintext or keys. | PASS | `receipts/R01.md` |
| A404 | Focused tests, full repository gate, production build, and native smoke pass. | PASS | `receipts/R02.md` |
| A405 | Independent final review, V1B verdict, and continuation handoff are committed and pushed. | PASS | `V1B_VERDICT.md`, `HANDOFF.md`, `receipts/R02.md` |
