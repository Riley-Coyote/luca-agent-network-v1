...
| `read` | unsupported | PostgreSQL read-replica pool; single-node has one SQLite writer |
| `read_pool_stats` | unsupported | PostgreSQL read-replica pool; single-node has one SQLite writer |
