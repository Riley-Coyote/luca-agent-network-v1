...
/// Luca Project (parameterized replaceable, owner-authored).
///
...
pub const KIND_LUCA_PROJECT: u32 = 30178;
...
const _: () = assert!(is_parameterized_replaceable(KIND_LUCA_PROJECT)); // 30178 ∈ 30000–39999
